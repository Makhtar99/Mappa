...
//
// L'Excel eHuB indique 14 entites par lyre (10..23, 30..43, 50..63, 70..83).
// L'ordre exact des 14 canaux depend du modele physique. Profil courant type
// pour tete mobile 14 canaux : pan16, tilt16, speed, dimmer, strobe, R, G, B,
// W, macro/couleur, auto, reset. Le 14e canal est souvent un "macro" ou
// "color wheel" ; on l'expose ici comme "macro". Ajuster l'ordre ci-dessous
// SANS toucher au routing : seule la sequence des octets change.
public sealed class LyreController : MonoBehaviour
{
    ...
    [Range(0f, 1f)] public float macro = 0f; // 14e canal : macro couleur / gobo / auto
    ...
    private void Update()
    {
        ...
        _ch[12] = 0;                       // canal 13 : auto/voice (manuel)
        _ch[13] = 0;                       // canal 14 : reset
